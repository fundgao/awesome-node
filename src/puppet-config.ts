...
const isPuppetModuleName = (name: string): name is OfficialPuppetNpmName =>
  name in OFFICIAL_PUPPET_DEPENDENCIES;
 ...
 */
const OFFICIAL_PUPPET_DEFAULT: OfficialPuppetNpmName =
