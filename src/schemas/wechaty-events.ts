...
const WECHATY_EVENT_DICT = {
  ...
  heartbeat:
    "Will be emitted periodically after the Wechaty started. If not, means that the Wechaty had died.",
...
const WechatyEventEmitter =
  EventEmitter as any as new () => TypedEventEmitter<WechatyEventListeners>;
