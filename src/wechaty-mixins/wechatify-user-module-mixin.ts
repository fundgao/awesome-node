...
const wechatifyUserModuleMixin = <MixinBase extends typeof WechatySkeleton>(
  mixinBase: MixinBase
) => {
  log.verbose(
    "WechatifyUserModuleMixin",
    "wechatifyUserModuleMixin(%s)",
    mixinBase.name
  );
  ...
  abstract class WechatifyUserModuleMixin extends mixinBase {
    ...
    override async init(): Promise<void> {
      ...
      if (this.__wechatifiedMessage) {
        log.verbose(
          "WechatifyUserModuleMixin",
          "init() Wechaty User Module (WUM)s have already wechatified: skip"
        );
        return;
      }
      ...
      log.verbose(
        "WechatifyUserModuleMixin",
        "init() initializing Wechaty User Module (WUM) ..."
      );
      ...
      this.__wechatifiedContactSelf = wechatifyUserModule(ContactSelfImpl)(
        this as any
      );
      this.__wechatifiedDelay = wechatifyUserModule(DelayImpl)(this as any);
      this.__wechatifiedFriendship = wechatifyUserModule(FriendshipImpl)(
        this as any
      );
      this.__wechatifiedImage = wechatifyUserModule(ImageImpl)(this as any);
      this.__wechatifiedLocation = wechatifyUserModule(LocationImpl)(
        this as any
      );
      this.__wechatifiedMessage = wechatifyUserModule(MessageImpl)(this as any);
      this.__wechatifiedMiniProgram = wechatifyUserModule(MiniProgramImpl)(
        this as any
      );
      ...
      this.__wechatifiedRoomInvitation = wechatifyUserModule(
        RoomInvitationImpl
      )(this as any);
      ...
      log.verbose(
        "WechatifyUserModuleMixin",
        "init() initializing Wechaty User Module (WUM) ... done"
      );
    }
  }
...
function guardWechatify<T extends Function>(userModule?: T): T {
  ...
  throw new Error(
    "Wechaty User Module (WUM, for example: wechaty.Room) can not be used before wechaty.start()!"
  );
}
